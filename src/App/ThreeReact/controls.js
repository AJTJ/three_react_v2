    ...
    return (
      <form
        className={`controlsForm ${
          this.props.controlsHidden ? "controlsHidden" : ""
        }`}
        action=""
      >
        ...
        <div className="sectionWrapper">
          ...
          <div className="sliderDiv">
            ...
            <input
              onChange={this.props.verticesChange}
              className="slider"
              type="range"
              min="0"
              max="5"
              value={this.props.vertices}
            />
          </div>
        </div>
        ...
        <div className="sectionWrapper">
          ...
          <div className="bulbSpeed__wrapper">
            <div className="bulbControl__wrapper">
              ...
              <div>
                <NumericInput
                  onChange={this.props.topBulbSpeedChange}
                  className="numberInput"
                  step={0.001}
                  max={1}
                  min={-1}
                  value={this.props.topBulbSpeed}
                />
            ...
            <div className="bulbControl__wrapper">
              ...
              <div>
                <NumericInput
                  onChange={this.props.middleBulbSpeedChange}
                  className="numberInput"
                  step={0.001}
                  max={1}
                  min={-1}
                  value={this.props.middleBulbSpeed}
                />
              </div>
            </div>
            ...
            <div className="bulbControl__wrapper">
              ...
              <div>
                <NumericInput
                  onChange={this.props.bottomBulbSpeedChange}
                  className="numberInput"
                  step={0.001}
                  max={1}
                  min={-1}
                  value={this.props.bottomBulbSpeed}
                />
              </div>
            </div>
          </div>
        ...
        <div className="sectionWrapper">
          ...
          <div className="bulbSpeed__wrapper">
            <div className="bulbControl__wrapper">
              ...
              <div>
                <NumericInput
                  onChange={this.props.topBulbLumChange}
                  className="numberInput"
                  step={50}
                  max={2000}
                  min={1}
                  value={this.props.topBulbLum}
                />
              </div>
            </div>
            ...
            <div className="bulbControl__wrapper">
              ...
              <div>
                <NumericInput
                  onChange={this.props.middleBulbLumChange}
                  className="numberInput"
                  step={50}
                  max={2000}
                  min={1}
                  value={this.props.middleBulbLum}
                />
              </div>
            </div>
            ...
            <div className="bulbControl__wrapper">
              ...
              <div>
                <NumericInput
                  onChange={this.props.bottomBulbLumChange}
                  className="numberInput"
                  step={50}
                  max={2000}
                  min={1}
                  value={this.props.bottomBulbLum}
                />
              </div>
            </div>
          </div>
        ...
        <div className="sectionWrapper">
          ...
          <div className="colorButtons">
            <div className="colorButton__wrapper">
              ...
              <p>
                Currently: <span style={shapeColor}>{this.props.color}</span>
              </p>
            </div>
            ...
            <div className="colorButton__wrapper">
              <div className="colorButtonDiv">
                <input
                  onClick={this.props.getRandomLightsColor}
                  className="randomColorButton"
                  type="button"
              ...
              <p>
                Currently:{" "}
                <span style={lightsColor}>{this.props.lightsColor}</span>
              </p>
            </div>
          </div>
